  ...
  return (
    ...
    >
      ...
      <div ref={gridRef} className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 md:gap-12">
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li className="font-mono text-xs text-foreground/80">ghosty</li>
        ...
        <div className="col-span-1">
          ...
          <ul className="space-y-2">
            <li>
              <a
                href="https://instagram.com/corpsealone"
                target="_blank"
      ...
      >
        ...
        <p className="font-mono text-[10px] text-muted-foreground">Crafted with precision. Built for the future.</p>
      </div>
    </section>
  )
}
